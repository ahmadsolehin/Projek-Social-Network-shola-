...
if(isset($_POST["submit"])){
  ...
  $sql = "INSERT INTO service(Username, Service_name, Service_category, Price, Service_description, Created_date) VALUES (' $u','$sn','$sc','$p','$sd', now())";
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="" name="service_name"  placeholder="Service Name" required>
                      ...
                      <div class="form-group"> 
                        ...
                        <div class="form-group"> 
                          ...
                          <div class="input-group">
                            <div class="input-group-addon"><span class=""></span></div>
                            <input type="number" class="form-control" id="" name="price"  placeholder="Price" required>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            Short Service Description<br>  <textarea rows="5" cols="55"  name="service_description" placeholder="Service Description" required>  </textarea>
                          ...
                          <div class="input-group">
                            ...
                            Full Service Description<br>  <textarea rows="5" cols="55"  name="service_full_description" placeholder="Full Service Description" required>  </textarea>
