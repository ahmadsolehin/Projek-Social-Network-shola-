...
include_once("php_includes/db_conx.php");
  ...
  $p2 =  mysqli_real_escape_string($db_conx, $_POST['password2']);
  $id =  mysqli_real_escape_string($db_conx, $_POST['id']);

  if ($p == $p2) {
    
  $password = md5($p);
       $query = "update users set password='".($password)."' where username='".$_GET['u']."'";
...
//        echo $query;
    ...
    header("location: changepassToLogin.php");
    ...
    <script language='Javascript'>
      alert('Not same .. ');
      location.href='changepass.php?u=<?php echo $id ?>';
...
<div class="login-block">
    ...
    <form method="post" action="changepass.php?u=<?php echo $_GET['u']?>" id="reset" name="loginform">
    <input type="password" value="" placeholder="New password" id="password" name="password" required>
    <input type="password" value="" placeholder="New password again" id="password2" name="password2" required>

        <input type="hidden" value="<?php echo $_GET['u']?>" name="id" required>
