  ...
  .fa-remove{
    ...
    margin-top:-3px
           ...
           <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Link Facebook Page</a>
                </h4>
              </div>
              <div id="collapse2" class="panel-collapse collapse">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-addon"><span class=" "></span></div>
                    <textarea rows="9" cols="47"  name="fb" placeholder="Paste Facebook Code"><?php echo  $facebook ; ?> </textarea>
