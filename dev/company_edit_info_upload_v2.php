...
{
  $nosql = "UPDATE company SET about ='$a', location ='$l' , website = '$web', facebook = '$facebook' WHERE username = '$u' ";
  $quey = mysqli_query($db_conx, $nosql);

} else {
// results not found
  $oppo = "INSERT INTO company(about , website, location , product_pic , facebook, username , timedate) VALUES ( '$a', '$web', '$l' , '' ,  '$facebook' ,'$u' , now() ) ";
