...
if(isset($_POST["submit"])){
  ...
  $facebook= mysqli_real_escape_string($db_conx, $_POST['fb']);
 
     $sql = "INSERT INTO company_social_media(username, facebook, date)  VALUES('$u','$facebook',now())";
    ...
    <script language='Javascript'>
      ...
      location.href='companyprofile.php';
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-10">
              ...
              <div class="login-block">
                ...
                <form method="post" action="company_link_facebook.php" >
                
                Paste Generated Code: <textarea rows="15" cols="43" name= "fb" required>
