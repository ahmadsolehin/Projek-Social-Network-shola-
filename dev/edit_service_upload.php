...
if(isset($_FILES['service_img'])){
      ...
      $ServiceID = mysqli_real_escape_string($db_conx, $_POST['ServiceID']);
	...
	if ($path[1]!="")
		$service_pic = "Service_pic = '$path[1]',";
	
}
$sql = "UPDATE service SET Username = '$u' , Service_name = '$sn', Service_category = '$sc', Price = '$p', Service_description = '$sd',  $service_pic Created_date = now() WHERE Service_id='$ServiceID' ";
	echo $sql;
	/* $sql = "INSERT INTO service(Username, Service_name, Service_category, Price, Service_description, Service_pic = '$path[1]' ,Created_date) VALUES ('$u','$sn','$sc','$p','$sd', '$path[1]' , now())"; */
