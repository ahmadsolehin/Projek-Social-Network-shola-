    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navCollapse">
        ...
        <ul id="menulist" class="nav navbar-nav navbar-right">
          ...
          <li class=""> <a class="page-scroll" style="font-style: bold;color:white" href="#talent">How It Works</a></li>
...
<header id="head">
  <div id="bg-fade-carousel" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <article>
          <h2 id="vidh">Show your Skills - Develop Yourself - <br><br> Opportunities will Come to You</h2>
        </article>
        <div   align="center" class="embed-responsive embed-responsive-16by9">
          ...
          <video autoplay="" loop="" class="fillWidth fadeIn animated" poster="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/polina.jpg" id="video-background">
            <source src="https://thenewcode.com/assets/videos/polina.mp4" type="video/mp4">Your browser does not support the video tag. I suggest you upgrade your browser.
            </video>
          </div>
        ...
        <div class="col-md-2" style="padding-right:0;padding-left:0;">
          <div class="thumbnail">
            <div class="caption">
              <h4>Services</h4>
              <p>Description</p>
              <p><a href="service_display_all.php" class="label label-danger" rel="tooltip" >Explore</a></p>
            </div>
...
<section id="talent">
<h3 class="text-center"><i> talent</i> </h3>
<div class="talent">
      <div class="row">
        <div class="col-md-3 col-sm-3 col-xs-3">
          <img src="img\howItWork\office.png" class="center-block img-responsive">
          <h4 class="text-center"><i>CREATE AN ACCOUNT</i></h4>
        </div>
        <!--</div>
        <div class="col-md-4">
        <i class="fa fa-long-arrow-right" style="font-size:48px;color:light-blue"></i>
        </div>-->
        <div class="col-md-3 col-sm-3 col-xs-3">
            <img src="img\howItWork\idea.png" class="center-block img-responsive">
          <h4 class="text-center"><i>SHOW YOUR TALENT</i></h4>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-3">
          <img src="img/howItWork/hire.png" style="width:150px;height:130px" class="center-block img-responsive">
          <h4 class="text-center"><i>GET HIRED</i></h4>
         </div>
         
        <div class="col-md-3 col-sm-3 col-xs-3">
          <img src="img/howItWork/paid.png" style="width:150px;height:130px" class="center-block img-responsive">
          <h4 class="text-center"><i>GET PAID</i></h4>
        </div>
      </div>
    </div>
  </section>
  ...
  <h3 class="text-center"><i> SEEKER</i></h3>
  <div class="seeker">
      <div class="row">
        <div class="col-md-4 col-sm-4 col-xs-4">
          <img src="img\howItWork\search.png" class="center-block img-responsive">
          <h4 class="text-center"><i>SEARCH FOR TALENT</i></h4>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-4">
            <img src="img\howItWork\hire.png" style="width:150px;height:130px"; class="center-block img-responsive">
          <h4 class="text-center"><i>HIRE</i></h4>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-4">
          <img src="img/howItWork/pay.png" style="width:150px;height:130px" class="center-block img-responsive">
          <h4 class="text-center"><i>PAY</i></h4>
        </div>
      </div>
    </div>
  </section>
...
<div class="footer-center">
  ...
  <div class="footer-right">
    ...
    <div class="footer-icons">
     ...
     <a href="https://www.facebook.com/grezzli.online/?fref=ts" target="_blank"><i class="fa fa-facebook"></i></a>
     <a href="https://www.instagram.com/grezzli_official/" target="_blank"><i class="fa fa fa-instagram"></i></a>
