...
$profile="";
  ...
  $profile = $row["profile"];
      ...
      $project="SELECT Project_name, Project_desc, Project_sdate, Project_edate FROM cv WHERE username='$u' ";
      $proj=mysqli_query($db_conx, $project);
      
      $skills="SELECT Skills FROM cv WHERE username='$u' ";
      $skill=mysqli_query($db_conx, $skills);
      
      $certificate="SELECT Certificate_Name, Certificate_Authority, Certificate_desc, Certificate_start_date, Certificate_end_date FROM cv WHERE username='$u' ";
      $cert=mysqli_query($db_conx, $certificate);
      
       $work_detail="SELECT Compnay_name, Company_position, Work_details, Work_start_date, Work_end_date FROM cv WHERE username='$u' ";
      $work=mysqli_query($db_conx, $work_detail);
      
      $education="SELECT University_name, University_level, University_start_date, University_end_date FROM cv WHERE username='$u' ";
        ...
        <div class="wrapper">
          <div class="sidebar-wrapper">
            <div class="profile-container">
              ...
              <h5 class="tagline"></h5>
            </div><!--//profile-container--  profile pic anil>
              ...
              <div class="item">
                <div class="meta">
                  <div class="row">
                    ...
                    title="My Role"><img src="img/company_nologo.png"  style="width:100px;height:40px"class="img-responsive" alt=""></a>
                  </div> -->
          ...
          <div class="item">
            <div class="meta">
              <div class="upper-row">
                ...
                <div class="time"><?php echo $sd1; ?> - <?php echo $ed1; ?></div>
              </div><!--//upper-row-->
