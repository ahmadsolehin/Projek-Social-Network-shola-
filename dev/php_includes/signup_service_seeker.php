...
//}
   ...
   // }
	...
	if (!file_exists('/home/grezzejn/public_html/dev/user_seeker/'. $folder_name)) {
		mkdir('/home/grezzejn/public_html/dev/user_seeker/'. $folder_name, 0755);
    ...
    // Email the user their activation link
		...
		$message = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Grezzli Message</title></head><body style="margin:0px; font-family:Tahoma, Geneva, sans-serif;"><div style="padding:10px; background:#333; font-size:24px; color:#CCC;"><a href="http://www.dev.grezzli.com"><img src="https://www.dev.grezzli.com/img/logo.png" width="36" height="30" alt="Grezzli" style="border:none; float:left;"></a>Grezzli Account Activation</div><div style="padding:24px; font-size:17px;">Hello '.$first_name.',<br /><br />Click the link below to activate your account when ready:<br /><br /><a href="https://www.dev.grezzli.com/activation_service_seeker.php?id='.$uid.'&u='.$username.'&p='.$pass_hash.'">Click here to activate your account now</a><br /><br />Login after successful activation using your:<br />* Username: <b>'.$username.'</b></div></body></html>';
		$headers = "From: $from\n";
