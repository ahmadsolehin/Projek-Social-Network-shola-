...
$config['callback_url']         =   'https://www.grezzli.com/service_provider_reg.php'; //Your callback URL
...
if($return['error']) // if invalid output error
{
 $content = 'Some error occured<br><br>'.$return['error_description'].'<br><br>Please Try again.';
  ...
  if (!file_exists('/home/grezzejn/public_html/user_provider/'. $folder_nama)) {
    mkdir('/home/grezzejn/public_html/user_provider/'. $folder_nama, 0755);
...
$redirect ='https://www.grezzli.com/service_provider_reg.php';
...
//  echo "<img src='$image' /><br><br>";
  ...
  if($count!=0)
  {
    ...
    // Create directory(folder) to hold each user's files(pics, MP3s, etc.)
  if (!file_exists('/home/grezzejn/public_html/user_provider/'. $folder_name)) {
    mkdir('/home/grezzejn/public_html/user_provider/'. $folder_name, 0755);
