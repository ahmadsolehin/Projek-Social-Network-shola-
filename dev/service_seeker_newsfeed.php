...
{
  header("Location: http://test.grezfzli.com/");
}
        ...
        $.ajax({
          ...
          success: function(response) {
            if(response.ResponseCode == 200){
              $('#postbox_'+post_id).load('service_seeker_newsfeed.php #postbox_'+post_id+' >*');
            }else{
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if(response.ResponseCode == 200){
             ...
             $('#feed_div').load('service_seeker_newsfeed.php #feed_div');
           }else{
            alert(response.Message);
          }
        }
