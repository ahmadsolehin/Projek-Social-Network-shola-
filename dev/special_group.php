  ...
  <div class="container">
    <div class="row" style="padding-top:50px;">
        ...
        <div id = "cursor" class="list-group list-group-horizontal">
          ...
          <a id="btn-member-special" class="list-group-item">Members</a>
          <a id="btn-request-special" class="list-group-item">Request</a>
          <a id="btn-setting" class="list-group-item">Setting</a>
        </div>
...
$(document).ready(function(){
        ...
        var hehe = '<?php echo $nama_kumpulan; ?>';
        var c = '<?php echo $id_kumpulan; ?>';

    $('#messagebox').load("special_group_chat.php?id="+hehe+"&ud="+c);
  ...
  $('#btn-request-special').click(function(){

    $('#messagebox').load("special_group_request.php?id="+hehe+"&ud="+c);
  })

    $('#btn-member-special').click(function(){

    $('#messagebox').load("special_group_member.php?id="+hehe+"&ud="+c);
  })

        $('#btn-setting').click(function(){


     $('#messagebox').load("special_group_setting.php?id="+hehe+"&ud="+c);
  })
