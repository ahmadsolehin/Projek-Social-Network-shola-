...
$msg_listing = "SELECT * FROM special_group_chat WHERE group_id = '$id_kumpulan' ";
$msg_array = mysqli_query($db_conx, $msg_listing);
$num_of_row = mysqli_num_rows($msg_array);

$xray = "SELECT * FROM special_group_chat WHERE group_id = '$id_kumpulan' ";
...
<script type="text/javascript">
  ...
  $('#reply').click(function(){
    ...
    var group_id = '<?php echo $id_kumpulan; ?>';

    $.ajax(
    {
      url : 'group/special_group_chat_insert.php',
      type: "POST",
      data : {
        username : username,
        message : msg,
