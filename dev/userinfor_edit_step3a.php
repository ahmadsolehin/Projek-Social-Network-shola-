<?php
  ...
  include_once("php_includes/db_conx.php");
	...
	header("Location: index.php");
      ...
      $s = mysqli_real_escape_string($db_conx, $_POST['uni_start_date']);
      $e = mysqli_real_escape_string($db_conx, $_POST['uni_start_date']);
      $sql = "INSERT INTO cv (username, University_name, University_level, University_study_field, University_major_course, University_start_date, University_end_date, Created_date) VALUES ('$u','$un','$el','$sf','$mc','$s','$e',now())";
            	$query = mysqli_query($db_conx, $sql);
            	header("location: userinfor_edit_step3a.php");
      }
...
<body id="page-top" class="index">
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-10">
              <p>Add another education details</p>
              <!-- form collapse goes here -->
              <form name="userinfor_edit_step3" action="userinfor_edit_step3.php" role="form" method="post">
                            ...
                            <div class="panel-body">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" id="university_name" name="university" placeholder="University name" required>
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <div class="input-group-addon"><span class="fa fa-university"></span></div>
                                  <input type="text" class="form-control" id="education_level" name="education_level"  placeholder="University level" required>
                                ...
                                <div class="input-group">
                                  <div class="input-group-addon"><span class="fa fa-university"></span></div>
                                  <input type="text" class="form-control" id="study_field" name="study_field" placeholder="Area of study" required>
                                ...
                                <div class="input-group">
                                  <div class="input-group-addon"><span class="fa fa-university"></span></div>
                                  <input type="text" class="form-control" id="major_course" name="major_course" placeholder="Enter Major Courses" required>
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <div class="input-group">
                                    <input type="text" name="uni_start_date"id="uni_start_date" class="form-control" placeholder="Start Year" />
                                    <span class="input-group-addon">-</span>
                                    <input type="text" name="uni_end_date" id="uni_end_date" class="form-control" placeholder="End Year" />
                                  </div>
                                </div>
 ...
 <p> <h4><a href="userinfor_edit_step4.php"><font color="black">Next</font></a></h4></p>
                    </div>
