<?php
   ...
   include_once("php_includes/db_conx.php");
	...
	header("Location: index.php");
      ...
      $cn = mysqli_real_escape_string($db_conx, $_POST['certificate_name']);
      $ca = mysqli_real_escape_string($db_conx, $_POST['certificate_authority']);
      $sy = mysqli_real_escape_string($db_conx, $_POST['start_year']);
      $ey = mysqli_real_escape_string($db_conx, $_POST['end_year']);
      $h = mysqli_real_escape_string($db_conx, $_POST['hobby']);
      $b = mysqli_real_escape_string($db_conx, $_POST['books']);
      $g = mysqli_real_escape_string($db_conx, $_POST['groups']);
      
      $sql = "UPDATE cv SET Certificate_Name='$cn', Certificate_Authority='$ca', Certificate_start_date='$sy', Certificate_end_date='$ey', Hobbies='$h', Books='$b', Groups='$g', Created_date=now() WHERE username='$u' LIMIT 1";
            	$query = mysqli_query($db_conx, $sql);
            	header("location: http://test.grezzli.com/userprofile.php?u=".$_SESSION["fname"].$_SESSION["lname"]);
      }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-10">
              ...
              <form name="userinfor_edit_step4" action="userinfor_edit_step4.php" role="form" method="post">
                                ...
                                <div class="panel-body">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" id="certificate_name" name="certificate_name"  placeholder="Certificate name" required>
                                    ...
                                    <div class="input-group">
                                      <div class="input-group-addon"><span class="fa fa-university"></span></div>
                                      <input type="text" class="form-control" id="certificate_name" name="certificate_authority"  placeholder="Certification Authority" required>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <div class="input-group">
                                        <input type="text" id="work_start_date" name="start_year" class="form-control" placeholder="Start Year" />
                                        <span class="input-group-addon">-</span>
                                        <input type="text" id="work_end_date" name="end_year" class="form-control" placeholder="End Year" />
                                      </div>
                                    </div>
                                ...
                                <div class="panel-heading">
                                  ...
                                  <div class="panel-body">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        <div class="input-group-addon"><span class="fa fa-university"></span></div>
                                        <textarea class="form-control" id="hobby" name="hobby" rows="4" placeholder="Enter Hobbies"></textarea>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="panel-heading">
                                    ...
                                    <div class="panel-body">
                                      <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <div class="input-group-addon"><span class="fa fa-university"></span></div>
                                          <textarea class="form-control" id="book" name="books" rows="4" placeholder="Books you like.."></textarea>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                    ...
                                    <div class="panel-heading">
                                      ...
                                      <div class="panel-body">
                                        <div class="form-group">
                                          ...
                                          <div class="input-group">
                                            <div class="input-group-addon"><span class="fa fa-university"></span></div>
                                            <textarea class="form-control" id="group" name="groups" rows="4" placeholder="Groups you are member of.."></textarea>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
...
<script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
    ...
    $(document).ready(function(){
      ...
      $('#certficate_end_date').datepicker({
        format: "dd/mm/yyyy"
      });
