<?php
   ...
   include_once("php_includes/db_conx.php");
	...
	header("Location: index.php");
      ...
      $pn = mysqli_real_escape_string($db_conx, $_POST['project_name1']);
      $pd = mysqli_real_escape_string($db_conx, $_POST['project_detail1']);
      $sy1 = mysqli_real_escape_string($db_conx, $_POST['start_year1']);
      $ey1 = mysqli_real_escape_string($db_conx, $_POST['end_year1']);
      $s = mysqli_real_escape_string($db_conx, $_POST['skills']);
    
      
      $sql = "UPDATE cv SET Project_name='$pn', Project_desc='$pd', Project_sdate='$sy1', Project_edate='$ey1', Skills='$s', Created_date=now() WHERE username='$u' LIMIT 1";
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-10">
              ...
              <form name="userinfor_edit_step4" action="userinfor_edit_step5.php" role="form" method="post">
                                ...
                                <div class="panel-body">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" id="project_name1" name="project_name1"  placeholder="Project name" required>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        <div class="input-group-addon"><span class="fa fa-university"></span></div>
                                        <textarea class="form-control" id="project_detail1" name="project_detail1" rows="4" placeholder="Project Details" required></textarea>
                                      </div>
                                    </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <div class="input-group">
                                        <input type="text" id="work_start_date" name="start_year1" class="form-control" placeholder="Start Year" />
                                        <span class="input-group-addon">-</span>
                                        <input type="text" id="work_end_date" name="end_year1" class="form-control" placeholder="End Year" />
                                      </div>
                                    </div>
                                ...
                                <div class="panel-heading">
                                  ...
                                  <div class="panel-body">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        <div class="input-group-addon"><span class="fa fa-university"></span></div>
                                        <textarea class="form-control" id="skills" name="skills" rows="4" placeholder="Enter Skills" required></textarea>
                                      </div>
                                    </div>
                                  </div>
                                </div>
