...
$services="SELECT Service_id, Service_name, Service_category, Price, Service_description, Service_pic , id FROM service WHERE Username='$u' GROUP BY Service_pic ";
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="row">
                  ...
                  while ($row = mysqli_fetch_array($service, MYSQLI_ASSOC)) {
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6" service_id="<?php echo $sid; ?>">
...
<a style="color:black; " href="userprofile_edit_service.php?ServiceID=<?php echo $sid; ?>"  class="pull-right" >
          <span class="glyphicon glyphicon-edit"></span> 
        </a>

             <a href="userprofile_display_service.php?ServiceID=<?php echo $sid; ?>&id=<?php echo $id_service; ?>"> 
                            <div class="col-md-4 col-sm-4 col-xs-4">
                             <!-- <img src="img/user_rating.png" class="img-responsive" alt=""> -->
                            </div>
             ...
             <a href="userprofile_display_service.php?ServiceID=<?php echo $sid; ?>&id=<?php echo $id_service; ?>"> 
                        ...
                        <div class="panel-footer">
                          <a style="color:black" href="userprofile_display_service.php?ServiceID=<?php echo $sid; ?>">
                            <div class="row">
