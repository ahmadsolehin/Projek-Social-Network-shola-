...
$post_company = "SELECT * FROM company_post WHERE id = '$getid' AND username='$u' LIMIT 1";
...
if ($_FILES['image']['tmp_name']!='') {
    ...
    $pic_loc = $_FILES['image']['tmp_name'];
     ...
     if(move_uploaded_file($pic_loc,$folder.$pic))
     {
      ...
      $nosql = "UPDATE company_post SET title ='$title', image ='$folder$pic', description = '$desc' WHERE id = '$id' LIMIT 1";
  ...
  header("location: companyprofile.php");
      ...
      $nosql = "UPDATE company_post SET title ='$title', image ='$id_photo', description = '$desc' WHERE id = '$id' LIMIT 1";
              $quey = mysqli_query($db_conx, $nosql);
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-10">
              ...
              <form enctype="multipart/form-data" action="company_edit_post.php" role="form" method="post">



                <div class="form-group">
                        <input type="text" class="form-control" id="" name="title" placeholder="Enter title" value="<?php echo $t; ?>" required>
                    </div>

       <div class="form-group">
       <img src="<?php echo $i; ?>" id = "blah" class="img-rounded" width="230" height="223">

                                            <input type="hidden" name="id_photo" value="<?php echo $i; ?>">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" type="textarea" id="message" placeholder="Enter description" name="desc" maxlength="350" rows="7"> <?php echo $desc; ?> </textarea>
                    </div>
