...
mysqli_query($db_conx,"INSERT INTO contact (name , email , subject , issue , message) 
VALUES ('$name' , '$email' , '$subject' , '$issue' , '$message')");
             ...
             <div class=" rowie summary-section" id="summary">
              <div class="summary">
                ...
                <form role="form" action="contact_Form.php" method="post">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" type="textarea" id="message" placeholder="Message" name="message" maxlength="150" rows="7"></textarea>
                        <span id="characterLeft">150</span> characters remaining  
