          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="media conversation headbox" id="<?php echo $gn; ?>" >
                  <button type="button" id="<?php echo $gid; ?>" class="btn-newgroup pull-right btn btn-default">Join</button>
      ...
      while ($row = mysqli_fetch_array($query2, MYSQLI_ASSOC)) {
        ...
        <div class="col-md-6 col-sm-6 col-xs-6">
          <div class="panel panel-default">
            ...
            <a style = "color:black;" href="../new_group.php?id=<?php echo $id_special; ?>"><?php echo $gn_special; ?></a>              
            </div>
            <div class="panel-body">
                <div class="media conversation headbox" id="<?php echo $gn_special; ?>" >
                  <button type="button" id="<?php echo $id_special; ?>" class="btn-special pull-right btn btn-default">Join</button>
                  <div class="media-body">
                    <h5 class="media-heading"><?php echo $pr_special; ?> Group
                    </h5>
                        <small>Created by : <?php echo $cb_special; ?></small>
                  </div>
                </div>
            </div>
          </div>
        ...
        <form id="form_add_exp" method="post" action="group/create_special_group.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <select id="skill_user" class="js2 form-control" multiple="multiple" name="skill[]" style="width: 100%;">


                <?php  
                while ($row = mysqli_fetch_array($skill_array, MYSQLI_ASSOC)) {
                  $ski = $row["skill_service_provider"];
                  ?>

                  <option value="<?php echo $ski;?>"><?php echo $ski; ?></option>
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="other" placeholder="Enter other skill"/>
            </div>
          </div>
