...
$config['callback_url']         =   'http://test2.grezzli.com/service_provider_reg.php'; //Your callback URL
...
if($return['error']) // if invalid output error
{
 $content = 'Some error occured<br><br>'.$return['error_description'].'<br><br>Please Try again.';
    ...
    else // token received successfully
    {
     ...
     //  print_r($User);
       ...
       if($count_emel!=0)
       {
        ...
        $sql = "INSERT INTO users (user_type, first_name, last_name, username, email, password, gender, country, city, avatar ,  signup, lastlogin, notescheck,   activated , security_question, security_answer)   VALUES('Service Provider','$nama_pertama','$nama_akhir','$folder_nama','$emel','','','','', '$pictureUrls' ,now(),now(),now(),'1','' , '')";
    ...
    //     $sqlcertification = "INSERT INTO certification (id, username) VALUES ('$uid','$folder_nama')";
    // $query4 = mysqli_query($link, $sqlcertification);

    // $sqlemployment = "INSERT INTO employment (id, username) VALUES ('$uid','$folder_nama')";
    // $query5 = mysqli_query($link, $sqlemployment);

    // $sqleducation = "INSERT INTO education (id, username) VALUES ('$uid','$folder_nama')";
    // $query6 = mysqli_query($link, $sqleducation);

    //     $sqlprojects = "INSERT INTO projects (id, username) VALUES ('$uid','$folder_nama')";
    // $query7 = mysqli_query($link, $sqlprojects);



    // Create directory(folder) to hold each user's files(pics, MP3s, etc.)
  if (!file_exists('/home/grezzejn/public_html/test2/user_provider/'. $folder_nama)) {
    mkdir('/home/grezzejn/public_html/test2/user_provider/'. $folder_nama, 0755);
...
$redirect ='http://test2.grezzli.com/service_provider_reg.php';
...
//  echo "<img src='$image' /><br><br>";
  ...
  if($count!=0)
  {
    ...
    $sql = "INSERT INTO users (user_type, first_name, last_name, username, email, password, gender, country, city, avatar ,  signup, lastlogin, notescheck,   activated , security_question, security_answer)   VALUES('Service Provider','$firstName','$lastName','$name','$email','','','','', '$image' ,now(),now(),now(),'1','' , '')";
    ...
    //     $sqlcertification = "INSERT INTO certification (id, username) VALUES ('$uid','$name')";
    // $query4 = mysqli_query($link, $sqlcertification);

    // $sqlemployment = "INSERT INTO employment (id, username) VALUES ('$uid','$name')";
    // $query5 = mysqli_query($link, $sqlemployment);

    // // $sqleducation = "INSERT INTO education (id, username) VALUES ('$uid','$name')";
    // // $query6 = mysqli_query($link, $sqleducation);

    //     $sqlprojects = "INSERT INTO projects (id, username) VALUES ('$uid','$name')";
    // $query7 = mysqli_query($link, $sqlprojects);
    ...
    // Create directory(folder) to hold each user's files(pics, MP3s, etc.)
  if (!file_exists('/home/grezzejn/public_html/test2/user_provider/'. $folder_name)) {
    mkdir('/home/grezzejn/public_html/test2/user_provider/'. $folder_name, 0755);
...
<?php include_once ("header_reg.php"); ?>
  ...
  <div class="container">
    ...
    <form name="signup_provider_reg" action="php_includes/signup_service_provider.php" role="form" method="post" >
    ...
    <div class="input-group">
      <div class="input-group-addon"><i class="fa fa-user"></i></div>
        ...
        <div class="input-group">
          ...
          <input id="emailchecker" placeholder="Enter email" class="form-control classname" autocomplete="off" name="InputEmail" readonly type="email" onfocus="if (this.hasAttribute('readonly')) { this.removeAttribute('readonly');
...
<style type="text/css">
  ...
  input[readonly].classname{
    ...
    font-size: 1em;
        ...
        <!-- Sex -->
        <div class="form-group">
      <label class="col-md-4 col-sm-4 col-xs-4 control-label" for="selectbasic">Gender</label>
      <div class="col-md-8 col-sm-8 col-xs-8 ">
        <select id="selectbasic" name="Gender" class="form-control" required>
    ...
    <div class="input-group">
              <div class="input-group-addon"><i class="fa fa-user"></i></div>
                <input type="text" class="form-control" name="Answer" id="Answer" placeholder="Answer Security Question" required>
                <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
            </div> </br>
       <div class="radio">
    ...
    <!-- <% include includes/signup_form_individual.ejs %> -->
