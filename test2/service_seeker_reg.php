...
$config['callback_url']         =   'http://test2.grezzli.com/service_seeker_reg.php'; //Your callback URL
...
if($return['error']) // if invalid output error
{
 $content = 'Some error occured<br><br>'.$return['error_description'].'<br><br>Please Try again.';
    ...
    // Create directory(folder) to hold each user's files(pics, MP3s, etc.)
        if (!file_exists('/home/grezzejn/public_html/test2/user_seeker/'. $folder_nama)) {
          mkdir('/home/grezzejn/public_html/test2/user_seeker/'. $folder_nama, 0755);
  ...
  $redirect ='http://test2.grezzli.com/service_seeker_reg.php';
