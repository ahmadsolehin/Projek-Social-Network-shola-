...
$work_detail="SELECT id , compnay_name, company_position, work_details, work_start_date, work_end_date FROM employment WHERE username='$u' ";
        ...
        <form id="form_add_exp" method="post" action="ser_provider/add_new_experience.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              id="" name="company_name" placeholder="Enter company name"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="company_position" placeholder="Enter position name"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Work </label>
            <div class="col-sm-10">
              <textarea name="work_details" rows="7" placeholder="Enter work details" class="form-control" style="min-width: 100%"></textarea>
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_edit_exp" class="form-horizontal" role="form"  method="post" action="ser_provider/edit_experience.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="edit_company_name" placeholder="Enter company name"/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="edit_company_position" placeholder="Enter position name"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Work </label>
            <div class="col-sm-10">
              <textarea name="edit_work_details" rows="7" placeholder="Enter work details" class="form-control" style="min-width: 100%"></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Start </label>
            <div class="col-sm-10">
              <input type="text" name = "edit_work_start_date" id="edit_work_start_date" class="form-control" placeholder="Start Year" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">End </label>
            <div class="col-sm-10">
              <input type="text" name = "edit_work_end_date" id="edit_work_end_date" class="form-control" placeholder="End Year" />
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_add_exp" method="post" action="ser_provider/add_new_project.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="project_name" placeholder="Enter project name"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="project_description" rows="7" placeholder="Enter project description" class="form-control" style="min-width: 100%"></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Start </label>
            <div class="col-sm-10">
              <input type="text" name = "project_start_date" id="project_start_date" class="form-control" placeholder="Start Year" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">End </label>
            <div class="col-sm-10">
              <input type="text" name = "project_end_date" id="project_end_date" class="form-control" placeholder="End Year" />
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_edit_pro" method="post" action="ser_provider/edit_project.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="edit_project_name" placeholder="Enter project name"/>
              <input type="hidden" class="form-control" 
              id="" name="id_pro"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Description </label>
            <div class="col-sm-10">
              <textarea name="edit_project_description" rows="7" placeholder="Enter project description" class="form-control" style="min-width: 100%"></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Start </label>
            <div class="col-sm-10">
              <input type="text" name = "edit_project_start_date" id="edit_project_start_date" class="form-control" placeholder="Start Year" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">End </label>
            <div class="col-sm-10">
              <input type="text" name = "edit_project_end_date" id="edit_project_end_date" class="form-control" placeholder="End Year" />
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_add_education" method="post" action="ser_provider/add_new_education.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="university_name" placeholder="Enter university name"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="university_level" placeholder="Enter university level"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="area_study" placeholder="Enter area of study"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="major_course" placeholder="Enter major course"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Start </label>
            <div class="col-sm-10">
              <input type="text" name = "edu_start_date" id="edu_start_date" class="form-control" placeholder="Start Year" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">End </label>
            <div class="col-sm-10">
              <input type="text" name = "edu_end_date" id="edu_end_date" class="form-control" placeholder="End Year" />
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_edit_edu" method="post" action="ser_provider/edit_education.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="edit_university_name" placeholder="Enter university name"/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="edit_university_level" placeholder="Enter university level"/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="edit_area_study" placeholder="Enter area of study"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="edit_major_course" placeholder="Enter major course"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Start </label>
            <div class="col-sm-10">
              <input type="text" name = "edit_education_start_date" id="edit_education_start_date" class="form-control" placeholder="Start Year" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">End </label>
            <div class="col-sm-10">
              <input type="text" name = "edit_education_end_date" id="edit_education_end_date" class="form-control" placeholder="End Year" />
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_add_cert" method="post" action="ser_provider/add_new_certificate.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="certificate_name" placeholder="Enter certificate name"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="issue_authority" placeholder="Enter issue authority"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Description </label>
            <div class="col-sm-10">
              <textarea name="brief_description" rows="7" placeholder="Enter brief description" class="form-control" style="min-width: 100%"></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Start </label>
            <div class="col-sm-10">
              <input type="text" name = "cert_start_date" id="cert_start_date" class="form-control" placeholder="Start Year" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">End </label>
            <div class="col-sm-10">
              <input type="text" name = "cert_end_date" id="cert_end_date" class="form-control" placeholder="End Year" />
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_edit_cert" method="post" action="ser_provider/edit_certificate.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="edit_certificate_name" placeholder="Enter certificate name"/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" 
              id="" name="edit_issue_authority" placeholder="Enter issue authority"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Description </label>
            <div class="col-sm-10">
              <textarea name="edit_brief_description" rows="7" placeholder="Enter brief description" class="form-control" style="min-width: 100%"></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">Start </label>
            <div class="col-sm-10">
              <input type="text" name = "edit_cert_start_date" id="edit_cert_start_date" class="form-control" placeholder="Start Year" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            for="">End </label>
            <div class="col-sm-10">
              <input type="text" name = "edit_cert_end_date" id="edit_cert_end_date" class="form-control" placeholder="End Year" />
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_add_education" method="post" action="ser_provider/add_new_summary.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            for="">Summary </label>
            <div class="col-sm-10">
              <textarea name="x" rows="7" placeholder="Enter profile summary" class="form-control" style="min-width: 100%"></textarea>
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_add_education" method="post" action="ser_provider/add_new_language.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            for="">Language </label>
            <div class="col-sm-10">
              <textarea name="add_language" rows="7" placeholder="Enter language" class="form-control" style="min-width: 100%"></textarea>
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_add_education" method="post" action="ser_provider/add_new_interest.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            for="">Interest </label>
            <div class="col-sm-10">
              <textarea name="add_interest" rows="7" placeholder="Enter interest" class="form-control" style="min-width: 100%"></textarea>
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <form id="form_add_education" method="post" action="ser_provider/add_new_skill.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            for="">Skill </label>
            <div class="col-sm-10">
              <input type="text" name = "add_skill" placeholder="Enter skill" class="form-control" />
      ...
      <div class="modal-body">
        ...
        <form id="" method="post" action="ser_provider/edit_new_skill.php" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name = "edit_skill" placeholder="Enter skill" class="form-control" />
